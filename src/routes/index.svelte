<script>
  import victor from '$lib/images/victor.png';
</script>
...
<svelte:head>
  ...
  <meta
    ...
    content="I'm a software developer, teacher, and cybersecurity student based in Montreal 🇨🇦. Welcome to my website!"
  />
</svelte:head>
...
<div class="container">
  ...
  <div>
    <img src={victor} loading="lazy" alt="" />
  </div>
</div>
